/*
 * File:   main.c
 * Author: Olamikun Aluko, Robert Meyer, Paulo Pineda
 *
...
uint16_t PB1_pressed = 0;
uint16_t PB2_pressed = 0;
uint16_t PB3_pressed = 0;
uint16_t noPressedPrinted = 0;
uint16_t anyPressed = 0;
